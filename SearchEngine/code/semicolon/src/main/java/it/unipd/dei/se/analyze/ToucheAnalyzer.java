...
import it.unipd.dei.se.parse.ParsedSentence;
...
import static it.unipd.dei.se.analyze.AnalyzerUtil.loadStopList;
...
public class ToucheAnalyzer extends Analyzer {
    ...
    protected TokenStreamComponents createComponents(String fieldName) {
        ...
        if(fieldName.equals(ParsedDocument.FIELDS.TEXT) || fieldName.equals(ParsedDocument.FIELDS.CONCLUSION) || fieldName.equals(ParsedSentence.FIELDS.SENT_TEXT)){
            tokens = new StopFilter(tokens, loadStopList("C:\\learning\\master\\SE\\project\\code\\semicolon\\src\\main\\resources\\glasgow.txt\\glasgow.txt"));
